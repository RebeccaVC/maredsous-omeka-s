...
RUN usermod -u 1000 www-data \
  && wget --no-verbose "https://github.com/omeka/omeka-s/releases/download/v3.2.2/omeka-s-3.2.2.zip" -O /var/www/omeka-s.zip \
  && unzip -q /var/www/omeka-s.zip -d /var/www/ \
  &&  rm /var/www/omeka-s.zip \
  &&  rm -rf /var/www/html/maredsous/ \
  &&  mv /var/www/omeka-s /var/www/html/maredsous/ \
